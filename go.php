...
echo "\n";
	...
	echo "\n";
	 ...
	 echo "\n";
         setpin:	 
	 echo "\n";
         echo color("white","[?] Mau Buat PIN ? (y/n) : ");
    ...
    echo "\n";
	 ...
	 echo "\n";
         goto setpin;
            ...
            echo color("red","[×] Kode OTP yang dimasukkan salah !!");
            echo "\n";
	    echo "\n";
